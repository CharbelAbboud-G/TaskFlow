...
CREATE TABLE `projects` (
  ...
  `status` enum('planning','active','completed','archived') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'planning',
...
CREATE TABLE `tasks` (
  ...
  KEY `fk_tasks_assigned_user` (`assigned_user_id`),
...
-- Dump completed on 2026-09-22  0:25:57
